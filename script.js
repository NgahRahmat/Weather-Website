...
const API = `3977598c0ea8419fa4717bc10dd2b995`;
...
async function findLocation(name) {
    ...
    try{
        ...
        if(result.cod !== "404"){
            ...
            const message = `<h2 class="weather-temp">${result.cod}</h2><h3 class="cloudtxt">${result.message}</h3>`;
...
function forecast(frContent){
    ...
    return `<li><img src="https://openweathermap.org/img/wn/${frContent.weather[0].icon}@2x.png"/>
                <span>${joinDay}</span>
